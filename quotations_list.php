...
?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="text-primary font-weight-bold view-quotation-detail"
                                    data-id="<?= $row['id'] ?>" data-no="<?= htmlspecialchars($row['quotation_no']) ?>">
                            ...
                            <td class="text-center align-middle">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <a href="quotations_print.php?id=<?php echo $row['id']; ?>" target="_blank"
        ...
        ?>
                                    <a href="<?php echo $wa_url; ?>" target="_blank" class="btn btn-info btn-sm"
                                        title="Send WhatsApp" style="background-color: #25d366; border-color: #25d366;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subject" class="form-control"
                            value="Quotation from CV Afshin Raya Teknik" required>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
        <div class="modal-content border-0 shadow">
            <div class="modal-body text-center py-5">
                ...
                <p class="text-muted mt-2 mb-4" id="successModalMessage">Quotation telah berhasil dikirim ke customer.
                </p>
