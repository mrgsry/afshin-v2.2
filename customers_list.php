    ...
    <div class="container">
        ...
        <div class="actions-bar">
            <form method="GET" class="search-box">
                ...
                <input type="text" name="search" placeholder="Search customers by name, phone, ID, or PIC..."
        ...
        <div class="table-container">
                        ...
                        <td>
                            <div class="actions-cell">
                                <a class="btn btn-primary btn-sm"
                                    href="customers_edit.php?id=<?php echo $row['id']; ?>">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a class="btn btn-danger btn-sm"
                                    href="customers_list.php?delete=<?php echo $row['id']; ?>&page=<?php echo $page; ?>"
                                    onclick="return confirm('Are you sure you want to delete customer <?php echo htmlspecialchars($row['name']); ?>?')">
            ...
            <div class="empty-state">
                ...
                <p><?php echo !empty($search) ? 'Try adjusting your search criteria' : 'Get started by adding your first customer'; ?>
                </p>
                <?php if(empty($search)): ?>
        ...
        <div class="pagination">
            <?php if($page > 1): ?>
            <a class="page-link"
                href="customers_list.php?page=<?php echo $page-1; ?>&search=<?php echo urlencode($search); ?>">
            ...
            <a class="page-link <?php echo $p == $page ? 'active' : ''; ?>"
                href="customers_list.php?page=<?php echo $p; ?>&search=<?php echo urlencode($search); ?>">
                <?php echo $p; ?>
            </a>
            <?php endfor; ?>
